...
asset_chair_root = "../assets"
asset_chair = "objects/3a431666-c294-41c8-85ca-2247a19e3671.urdf"

chair_asset = gym.load_asset(sim, asset_chair_root, asset_chair, asset_options)
...
env = gym.create_env(sim, env_lower, env_upper, envs_per_row)
actor = gym.create_actor(env, chair_asset, initial_pose, 'actor', 0, 1)
